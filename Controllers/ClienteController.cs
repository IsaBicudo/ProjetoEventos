...
namespace ProjetoEventos.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ClienteNome,ClienteCpf,ClienteEmail")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClienteNome,ClienteCpf,ClienteEmail")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
